...
#define ADI_SPORT_STATIC_INSTANCES             4ul

/**********************************************************************************************
 *					       SPORT 0A
 **********************************************************************************************/
/*!SPORT0A Instance*/
#define ADI_SPORT0A_INSTANCE                   0ul
...
#define ADI_SPORT0B_CTL_SLEN                    23ul
...
#define ADI_SPORT_0B_CTL   ((ADI_SPORT0B_CTL_SLEN<<BITP_SPORT_CTL_B_SLEN)|(ADI_SPORT0B_CTL_PACK<<BITP_SPORT_CTL_B_PACK)|(ADI_SPORT0B_CTL_ICLK<<BITP_SPORT_CTL_B_ICLK)|(ADI_SPORT0B_CTL_CKRE<<BITP_SPORT_CTL_B_CKRE)|(ADI_SPORT0B_CTL_IFS<<BITP_SPORT_CTL_B_IFS)|(ADI_SPORT0B_CTL_DIFS<<BITP_SPORT_CTL_B_DIFS)|(ADI_SPORT0B_CTL_LFS<<BITP_SPORT_CTL_B_LFS)|(ADI_SPORT0B_CTL_LAFS<<BITP_SPORT_CTL_B_LAFS)|(ADI_SPORT0B_CTL_GCLKEN<<BITP_SPORT_CTL_B_GCLKEN)|(ADI_SPORT0B_CTL_SPTRAN<<BITP_SPORT_CTL_B_SPTRAN)|(ADI_SPORT0B_CTL_OPMODE<<BITP_SPORT_CTL_B_OPMODE))
...
#define ADI_SPORT0B_DIV_CLKDIV                 32ul      
...
#define ADI_SPORT0B_DIV_FSDIV                  23ul          
 ...
 **********************************************************************************************/
/*!SPORT1B Instance*/
#define ADI_SPORT1B_INSTANCE                   1ul
...
/*! Selects word length in bits for the Half-SPORT's data transfers. */
#define ADI_SPORT1B_CTL_SLEN                   23ul
 ...
 *  	for (wordlength <= 31 bits)   -----> MSIZE = 4 Bytes , PSIZE = 4 Bytes.
 * */
#define ADI_SPORT1B_DMA_MSIZE  		 		ENUM_DMA_CFG_MSIZE04 /* 4  bytes transfer (32  bits) */
#define ADI_SPORT1B_DMA_PSIZE  		 		ENUM_DMA_CFG_PSIZE04 /* 4  bytes transfer (32  bits) */
 ...
 * 			0 : Clock falling edge
 * 			1 : Clock rising edge*/ 
#define ADI_SPORT1B_CTL_CKRE                   1ul
/*! Enables gated clock operation for the Half-SPORT.
 *  Configurable for DSP serial mode or left-justified stereo modes.
 *  This bit is ignored when the half SPORT is in right-justified mode or multichannel mode
 *  Configured as : 
...
/*! Specifies the SPORT1B_Control register Configuration*/
#define ADI_SPORT_1B_CTL   ((ADI_SPORT1B_CTL_SLEN<<BITP_SPORT_CTL_B_SLEN)|(ADI_SPORT1B_CTL_PACK<<BITP_SPORT_CTL_B_PACK)|(ADI_SPORT1B_CTL_ICLK<<BITP_SPORT_CTL_B_ICLK)|(ADI_SPORT1B_CTL_CKRE<<BITP_SPORT_CTL_B_CKRE)|(ADI_SPORT1B_CTL_IFS<<BITP_SPORT_CTL_B_IFS)|(ADI_SPORT1B_CTL_DIFS<<BITP_SPORT_CTL_B_DIFS)|(ADI_SPORT1B_CTL_LFS<<BITP_SPORT_CTL_B_LFS)|(ADI_SPORT1B_CTL_LAFS<<BITP_SPORT_CTL_B_LAFS)|(ADI_SPORT1B_CTL_GCLKEN<<BITP_SPORT_CTL_B_GCLKEN)|(ADI_SPORT1B_CTL_SPTRAN<<BITP_SPORT_CTL_B_SPTRAN)|(ADI_SPORT1B_CTL_OPMODE<<BITP_SPORT_CTL_B_OPMODE))


/*! Select the clock divisor that the Half-SPORT uses to calculate the sport clock from the processor system clock. 
* CLKDIV = ( SCLK / SPORT_ACLK) - 1 */
#define ADI_SPORT1B_DIV_CLKDIV                 32ul      
/*! Select the number of transmit or receive clock cycles that the Half-SPORT counts before generating a frame sync pulse. 
* FSDIV = (SPORT_ACLK / SPORT_AFS) - 1 */
#define ADI_SPORT1B_DIV_FSDIV                  23ul          
...
/*! Selects the window size for the Half-SPORT's active window of channels.
* WSIZE = (number of channel slots) -1 */ 
#define ADI_SPORT1B_MCTL_WSIZE 				     0ul
/*! Selects the delay (in serial clock cycles) between the Half-SPORT's multichannel frame sync pulse and channel 0 */
#define ADI_SPORT1B_MCTL_MFD					 0ul
/*! Enables DMA data packing for transmit and enables DMA data unpacking for the Half-SPORT's multichannel data transfers. 
 * Configured as:
 * 		0 : Disable
 * 		1 : Enable*/
#define ADI_SPORT1B_MCTL_MCPDE 				     0ul
/*! Enables multichannel operations for the Half-SPORT. 
 *  * Configured as:
 * 		0 : Disable
 * 		1 : Enable*/
#define ADI_SPORT1B_MCTL_MCE 					 0ul
...
/*! Specifies the SPORT1B_Multichannel Control register Configuration*/
#define ADI_SPORT_1B_CS0                         0x0
#define ADI_SPORT_1B_CS1						 0x0
#define ADI_SPORT_1B_CS2		        		 0x0
#define ADI_SPORT_1B_CS3						 0x0
 ...
 **********************************************************************************************/
/*!SPORT4B Instance*/
#define ADI_SPORT4B_INSTANCE                   1ul
 ...
 *  	for (wordlength <= 31 bits)   -----> MSIZE = 4 Bytes , PSIZE = 4 Bytes.
 * */
#define ADI_SPORT4B_DMA_MSIZE  		 		ENUM_DMA_CFG_MSIZE04 /* 4  bytes transfer (32  bits) */
#define ADI_SPORT4B_DMA_PSIZE  		 		ENUM_DMA_CFG_PSIZE04 /* 4  bytes transfer (32  bits) */
...
/*! Specifies the SPORT4B_Control register Configuration*/
#define ADI_SPORT_4B_CTL   ((ADI_SPORT4B_CTL_SLEN<<BITP_SPORT_CTL_B_SLEN)|(ADI_SPORT4B_CTL_PACK<<BITP_SPORT_CTL_B_PACK)|(ADI_SPORT4B_CTL_ICLK<<BITP_SPORT_CTL_B_ICLK)|(ADI_SPORT4B_CTL_CKRE<<BITP_SPORT_CTL_B_CKRE)|(ADI_SPORT4B_CTL_IFS<<BITP_SPORT_CTL_B_IFS)|(ADI_SPORT4B_CTL_DIFS<<BITP_SPORT_CTL_B_DIFS)|(ADI_SPORT4B_CTL_LFS<<BITP_SPORT_CTL_B_LFS)|(ADI_SPORT4B_CTL_LAFS<<BITP_SPORT_CTL_B_LAFS)|(ADI_SPORT4B_CTL_GCLKEN<<BITP_SPORT_CTL_B_GCLKEN)|(ADI_SPORT4B_CTL_SPTRAN<<BITP_SPORT_CTL_B_SPTRAN)|(ADI_SPORT4B_CTL_OPMODE<<BITP_SPORT_CTL_B_OPMODE))
...
/*! Multi-Channel (TDM) Mode : Selects the start location for the Half-SPORT's active window of channels within the 1024-channel range.
 *  For Right Justified Mode : The least significant 6 bits of WOFFSET serve as the delay count (DCNT) field*/
#define ADI_SPORT4B_MCTL_WOFFSET 				 0ul
/*! Selects the window size for the Half-SPORT's active window of channels.
* WSIZE = (number of channel slots) -1 */ 
#define ADI_SPORT4B_MCTL_WSIZE 				     0ul
/*! Selects the delay (in serial clock cycles) between the Half-SPORT's multichannel frame sync pulse and channel 0 */
#define ADI_SPORT4B_MCTL_MFD					 0ul
/*! Enables DMA data packing for transmit and enables DMA data unpacking for the Half-SPORT's multichannel data transfers. 
 * Configured as:
 * 		0 : Disable
 * 		1 : Enable*/
#define ADI_SPORT4B_MCTL_MCPDE 				     0ul
/*! Enables multichannel operations for the Half-SPORT. 
 *  * Configured as:
 * 		0 : Disable
 * 		1 : Enable*/
#define ADI_SPORT4B_MCTL_MCE 					 0ul
...
/*! Specifies the SPORT4B_Multichannel Control register Configuration*/
#define ADI_SPORT_4B_CS0                         0x0
#define ADI_SPORT_4B_CS1						 0x0
#define ADI_SPORT_4B_CS2		        		 0x0
#define ADI_SPORT_4B_CS3						 0x0
 ...
 **********************************************************************************************/
/*!SPORT5B Instance*/
#define ADI_SPORT5B_INSTANCE                   1ul
...
/*! Selects word length in bits for the Half-SPORT's data transfers. */
#define ADI_SPORT5B_CTL_SLEN                   23ul
 ...
 *  	for (wordlength <= 31 bits)   -----> MSIZE = 4 Bytes , PSIZE = 4 Bytes.
 * */
#define ADI_SPORT5B_DMA_MSIZE  		 		ENUM_DMA_CFG_MSIZE04 /* 4  bytes transfer (32  bits) */
#define ADI_SPORT5B_DMA_PSIZE  		 		ENUM_DMA_CFG_PSIZE04 /* 4  bytes transfer (32  bits) */
 ...
 * 			0 : Clock falling edge
 * 			1 : Clock rising edge*/ 
#define ADI_SPORT5B_CTL_CKRE                   1ul
/*! Enables gated clock operation for the Half-SPORT.
 *  Configurable for DSP serial mode or left-justified stereo modes.
 *  This bit is ignored when the half SPORT is in right-justified mode or multichannel mode
 *  Configured as : 
...
/*! Specifies the SPORT5B_Control register Configuration*/
#define ADI_SPORT_5B_CTL   ((ADI_SPORT5B_CTL_SLEN<<BITP_SPORT_CTL_B_SLEN)|(ADI_SPORT5B_CTL_PACK<<BITP_SPORT_CTL_B_PACK)|(ADI_SPORT5B_CTL_ICLK<<BITP_SPORT_CTL_B_ICLK)|(ADI_SPORT5B_CTL_CKRE<<BITP_SPORT_CTL_B_CKRE)|(ADI_SPORT5B_CTL_IFS<<BITP_SPORT_CTL_B_IFS)|(ADI_SPORT5B_CTL_DIFS<<BITP_SPORT_CTL_B_DIFS)|(ADI_SPORT5B_CTL_LFS<<BITP_SPORT_CTL_B_LFS)|(ADI_SPORT5B_CTL_LAFS<<BITP_SPORT_CTL_B_LAFS)|(ADI_SPORT5B_CTL_GCLKEN<<BITP_SPORT_CTL_B_GCLKEN)|(ADI_SPORT5B_CTL_SPTRAN<<BITP_SPORT_CTL_B_SPTRAN)|(ADI_SPORT5B_CTL_OPMODE<<BITP_SPORT_CTL_B_OPMODE))


/*! Select the clock divisor that the Half-SPORT uses to calculate the sport clock from the processor system clock. 
* CLKDIV = ( SCLK / SPORT_ACLK) - 1 */
#define ADI_SPORT5B_DIV_CLKDIV                 32ul      
/*! Select the number of transmit or receive clock cycles that the Half-SPORT counts before generating a frame sync pulse. 
* FSDIV = (SPORT_ACLK / SPORT_AFS) - 1 */
#define ADI_SPORT5B_DIV_FSDIV                  23ul          
...
/*! Multi-Channel (TDM) Mode : Selects the start location for the Half-SPORT's active window of channels within the 1024-channel range.
 *  For Right Justified Mode : The least significant 6 bits of WOFFSET serve as the delay count (DCNT) field*/
#define ADI_SPORT5B_MCTL_WOFFSET 				 0ul
/*! Selects the window size for the Half-SPORT's active window of channels.
* WSIZE = (number of channel slots) -1 */ 
#define ADI_SPORT5B_MCTL_WSIZE 				     0ul
/*! Selects the delay (in serial clock cycles) between the Half-SPORT's multichannel frame sync pulse and channel 0 */
#define ADI_SPORT5B_MCTL_MFD					 0ul
/*! Enables DMA data packing for transmit and enables DMA data unpacking for the Half-SPORT's multichannel data transfers. 
 * Configured as:
 * 		0 : Disable
 * 		1 : Enable*/
#define ADI_SPORT5B_MCTL_MCPDE 				     0ul
/*! Enables multichannel operations for the Half-SPORT. 
 *  * Configured as:
 * 		0 : Disable
 * 		1 : Enable*/
#define ADI_SPORT5B_MCTL_MCE 					 0ul
...
/*! Specifies the SPORT5B_Multichannel Control register Configuration*/
#define ADI_SPORT_5B_CS0                         0x0
#define ADI_SPORT_5B_CS1						 0x0
#define ADI_SPORT_5B_CS2		        		 0x0
#define ADI_SPORT_5B_CS3						 0x0
